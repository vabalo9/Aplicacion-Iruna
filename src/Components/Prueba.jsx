      ...
      <h4 className='titulo-indicativo'>Por favor en el menú superior indique la categoría a visualizar</h4>
        ...
        <div className='imagenes-principal'>
          ...
          <div className='imagenes'>
            ...
            <img className='imagen-itemDetail' src="http://iruna.hotels-argentina.net/data/Pics/OriginalPhoto/3179/317902/317902817/iruna-hotel-mar-del-plata-pic-25.JPEG" />
